...
This program is able to decode each of the English alphabet's 26 letters, plus the numbers 0-9, as shown in the dictionary above.
...
Some Morse dictionaries also include common punctuation marks. These have been omitted from the program at this stage.
...
Add punctuation, allowing several sentences.
